...
exports.gitMove = exports.isGitRepositorySync = exports.isGitRepository = void 0;
...
function gitMove(from, to) {
    ...
    ApplicationInsights_1.AppInsights.getInstance().trackEvent(ApplicationInsights_1.EventName.GitMove, appInsightsEntryProperties);
}
