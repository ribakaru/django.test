...
class MSDocs {
    ...
    static OpenSearchUrl(SearchString) {
        ...
        ApplicationInsights_1.AppInsights.getInstance().trackEvent(ApplicationInsights_1.EventName.SearchMicrosoftDocs, appInsightsEntryProperties);
    }
}
