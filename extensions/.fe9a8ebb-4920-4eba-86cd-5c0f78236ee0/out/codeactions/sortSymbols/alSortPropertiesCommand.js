...
class ALSortPropertiesCommand extends alCodeAction_1.ALCodeAction {
    ...
    collectCodeActions(docSymbols, symbol, document, range, diagnostics, actions) {
        if (!this.canRunOnSave(document)) {
            ...
            if ((symbol) && (symbol.isALObject()) && (symbol.kind != azSymbolKind_1.AZSymbolKind.Interface) &&
...
exports.ALSortPropertiesCommand = ALSortPropertiesCommand;
//# sourceMappingURL=alSortPropertiesCommand.js.map