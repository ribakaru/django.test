...
class ALSortUsingsCommand extends alCodeAction_1.ALCodeAction {
    ...
    collectCodeActions(docSymbols, symbol, document, range, diagnostics, actions) {
        if (!this.canRunOnSave(document)) {
            ...
            if ((symbol) &&
                (symbol.kind === azSymbolKind_1.AZSymbolKind.UsingDirective) &&
...
exports.ALSortUsingsCommand = ALSortUsingsCommand;
//# sourceMappingURL=alSortUsingsCommand.js.map