...
const alHoverProvider_1 = require("../editorextensions/alHoverProvider");
const devToolsExtensionService_1 = require("./devToolsExtensionService");
class HoverService extends devToolsExtensionService_1.DevToolsExtensionService {
    _alHoverProvider;
    constructor(context) {
        super(context);
        this._alHoverProvider = new alHoverProvider_1.ALHoverProvider(context);
